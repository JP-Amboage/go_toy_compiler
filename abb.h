...
/**
 * Imprime el contenido del arbol A en orden
 * @param A
 */
void inorden(abb A);

/**
 * Busca por clave y si no inserta.
 * Mejora en la eficiencia frente a buscar + insertar por separado
 * @param A
 * @param lexema Puntero a char con la cadena a  buscar/insertar
 */
int buscar_insertar(abb *A, char* lexema);
